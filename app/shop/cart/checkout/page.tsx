...
import type { FullAddress } from "@/app/shop/lib/definitions";
...
export default async function Page() {
  ...
  >`
    ...
    LIMIT 1
  `;
  const profile = profiles[0] ?? { first_name: null, last_name: null, phone: null };
  ...
  const defaultAddress: (FullAddress & { id: number; label?: string }) | null = a
    ? {
        id: a.id,

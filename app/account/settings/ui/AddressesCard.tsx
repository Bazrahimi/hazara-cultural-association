// app/account/settings/ui/AddressesCard.tsx
import { Button } from "@/app/ui/global/components";
import { Header } from "@/app/ui/global/Header";
import type { AddressRecord } from "../lib/definitions";
...
export default function AddressesCard({ addresses }: Props) {
  ...
  return (
    <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            return (
              ...
              >
                ...
                <div className="flex shrink-0 gap-2">
                  <Button
                    as="link"
                    href={`/account/settings/addresses/${a.id}/edit`}
                    variant="outline"
                    size="sm"
                  >
                    Edit
      ...
      {!hasDefaultAddress && hasAnyAddress && (
        <p className="mt-3 text-xs text-amber-700">
          Set a default address so checkout can be even faster.
        </p>
      )}
    </section>
  );
